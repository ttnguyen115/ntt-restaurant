...
import { ComponentProps, ComponentType, createContext, CSSProperties, ReactNode, use, useId, useMemo } from 'react';
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
    ...
    const colorConfigMapper = (theme: string) =>
