...
const AlertDialogTitle = ({ className, ref, ...props }: ComponentPropsWithRef<typeof AlertDialogPrimitive.Title>) => (
...
const AlertDialogAction = ({ className, ref, ...props }: ComponentPropsWithRef<typeof AlertDialogPrimitive.Action>) => (
...
const AlertDialogCancel = ({ className, ref, ...props }: ComponentPropsWithRef<typeof AlertDialogPrimitive.Cancel>) => (
