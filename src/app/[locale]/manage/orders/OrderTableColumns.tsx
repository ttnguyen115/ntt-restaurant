...
import { formatCurrency, formatDateTimeToLocaleString, getVietnameseOrderStatus, simpleMatchText } from '@/utilities';
...
import { useOrderTable } from './OrderTableContext';
...
const OrderTableColumns: ColumnDef<OrderItem>[] = [
    ...
    },
    {
        ...
        cell: function Cell({ row }) {
            const { orderObjectByGuestId } = useOrderTable();
